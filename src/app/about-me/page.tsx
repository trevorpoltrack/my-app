...
export default function AboutMe() {
	...
	return (
		<main className="min-h-screen flex flex-col items-center bg-background text-foreground p-6">
			...
			<section className="w-full max-w-3xl text-center mb-10 border border-blue-200 rounded-xl shadow bg-white dark:bg-gray-900 p-6">
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-4">
					<a
						href="mailto:trevorpoltrack@gmail.com"
			...
			<hr className="w-full max-w-2xl border-t-2 border-blue-200 my-8" />

			<section className="w-full max-w-3xl space-y-6 bg-white dark:bg-gray-900 border border-blue-200 rounded-xl shadow p-6">
				{sections.map((section, idx) => (
					<div
						key={section.title}
						className="mb-4 border-b last:border-b-0 border-blue-100 pb-4"
					>
